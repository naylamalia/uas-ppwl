...
<div class="container py-4">
    <h2 class="mb-4 fw-bold" style="color:firebrick;">Edit Pengguna</h2>
    ...
    <form action="{{ route('admin.users-management.update', $user->id) }}" method="POST" class="card p-4 shadow-sm" style="border-color:firebrick; background:#fff5f5;">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="password" class="form-label" style="color:firebrick;">Password <small class="text-muted">(Kosongkan jika tidak ingin mengubah)</small></label>
        ...
        <div class="d-flex justify-content-end gap-2 mt-4">
            <button type="submit" class="btn" style="background:firebrick; color:white;">Update Pengguna</button>
