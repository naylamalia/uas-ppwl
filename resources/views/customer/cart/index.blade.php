...
<div class="container py-4">
    ...
    @if(count($cart) > 0)
        <form action="{{ route('customer.cart.checkout.confirm') }}" method="POST" id="cartCheckoutForm">
            @csrf
                        ...
                        @foreach($cart as $item)
                            ...
                            <tr>
                                <td class="text-center">
                                    <input type="checkbox" name="selected_products[]" value="{{ $item['product_id'] }}" class="cart-checkbox">
                                </td>
                                <td>
...
document.getElementById('selectAllCart').onclick = function() {
